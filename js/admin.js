        ...
        var md = {
            ...
            func: {
                ...
                redirectToLogin: function() {
                    ...
                    $('<p></p>').text('To access Altus Business Solution dashboard, you have to login in our system').appendTo($form);
                    $msg.appendTo($form);
                    ...
                    $('<button></button>').attr({'type': 'submit'}).text('Login').addClass('btn btn-warning button_style').appendTo($fg);
                    $fg.appendTo($c.appendTo($r.appendTo($form)));
